"""
DSC DimRed + SE Attention experiment — training script.
"""
...
from architecture import build_dsc_dimred_attention_lead_cnn
...
def main():
    ...
    model = build_dsc_dimred_attention_lead_cnn(config=config)
