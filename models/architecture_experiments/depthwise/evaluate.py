"""
Depthwise experiment — evaluation script.
Loads the saved best weights and evaluates on the held-out test set.
"""
...
def main():
    ...
    save_run_results(
        ...
        extra_metrics={"architecture": "depthwise_separable"}
    )
