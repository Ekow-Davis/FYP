"""
v4_combined — Evaluation script.
Loads the final combined model and evaluates on the test set.
"""
...
def main():
    ...
    save_run_results(
        ...
        extra_metrics={"improvement": "kfold+class_weights", "note": "standalone_eval"}
    )
